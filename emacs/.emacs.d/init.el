...
(custom-set-variables
 ...
 '(package-selected-packages
   '(pdf-tools slime treemacs which-key use-package tuareg toml-mode tide slime-company selectrum-prescient rust-mode python-mode omnisharp nasm-mode lsp-ui lsp-pyright lsp-java js2-mode flymake-eslint flycheck-ocaml dired-toggle ac-slime))
